...
namespace _2024_WpfApp3
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            // 檢查是否選擇了內用或外帶
            if (DineInRadioButton.IsChecked != true && TakeOutRadioButton.IsChecked != true)
            {
                MessageBox.Show("請選擇內用或外帶", "提示", MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }

            takeout = DineInRadioButton.IsChecked == true ? "內用" : "外帶";
            ...
            if (orders.Count == 0)
            {
                MessageBox.Show("請至少選擇一項飲料", "提示", MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
